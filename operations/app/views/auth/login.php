...
<div class="container mt-5" style="max-width: 400px;">
    ...
    <div class="text-center mt-3">
        <p class="mb-2">Don't have an account? <a href="<?= URLROOT; ?>/auth/signup" class="text-primary">Sign Up</a></p>
        <p class="mb-0"><a href="<?= URLROOT; ?>/auth/activate" class="text-secondary">Activate Account</a></p>
    </div>
</div>
