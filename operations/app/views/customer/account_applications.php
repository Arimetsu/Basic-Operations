                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-2">
                                        <span class="info-label">Requested Services:</span>
                                        <div class="mt-1">
                                            <?php if ($app['wants_passbook']): ?>
                                                <span class="badge bg-success me-1"><i class="bi bi-book"></i> Passbook</span>
                                            <?php endif; ?>
                                            <?php if ($app['wants_atm_card']): ?>
                                                <span class="badge bg-primary me-1"><i class="bi bi-credit-card"></i> ATM Card</span>
                                            <?php endif; ?>
